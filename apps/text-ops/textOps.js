  ...
  return {
    ...
    onPredefinedOptionChange(e) {
      if (this.predefinedOption === "compose-escape") {
        ...
        this.predefinedOption === "csv-comma-to-latex-tabular-ampersand"
      ) {
        this.pattern = ",";
        this.replacement = "&";
      } else if (
        this.predefinedOption === "latex-tabular-ampersand-to-csv-comma"
      ) {
        this.pattern = "&";
        this.replacement = ",";
      } else if (this.predefinedOption === "caret-to-backslash") {
        this.pattern = "^";
        this.replacement = "\\";
      }
    },
